...
func (r *KubernetesSuite) TestMembers(c *C) {
	...
	expected := []*pb.MemberStatus{
		pb.NewMemberStatus("satellite-1", "192.168.1.101", map[string]string{"role": "master", "publicip": "192.168.1.101"}),
		pb.NewMemberStatus("satellite-2", "192.168.1.102", map[string]string{"role": "master", "publicip": "192.168.1.102"}),
	}
...
func (r *KubernetesSuite) TestMember(c *C) {
	...
	expected := pb.NewMemberStatus("satellite-1", "192.168.1.101",
		map[string]string{"role": "master", "publicip": "192.168.1.101"})
