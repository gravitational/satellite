...
type Heartbeat_Type int32

const (
	Heartbeat_UNKNOWN Heartbeat_Type = 0
	Heartbeat_REQUEST Heartbeat_Type = 1
	Heartbeat_ACK     Heartbeat_Type = 2
)

var Heartbeat_Type_name = map[int32]string{
	0: "UNKNOWN",
	1: "REQUEST",
	2: "ACK",
}
var Heartbeat_Type_value = map[string]int32{
	"UNKNOWN": 0,
	"REQUEST": 1,
	"ACK":     2,
}

func (x Heartbeat_Type) String() string {
	return proto.EnumName(Heartbeat_Type_name, int32(x))
}
func (Heartbeat_Type) EnumDescriptor() ([]byte, []int) { return fileDescriptorAgent, []int{9, 0} }
...
type Heartbeat struct {
	// Type marks this message as a request or response
	Type Heartbeat_Type `protobuf:"varint,1,opt,name=type,proto3,enum=agentpb.Heartbeat_Type" json:"type,omitempty"`
	// timestamp embeds the timestamp of the request in the message, used for RTT calculations
	// copied from request to ack to calcualte rtt
	Timestamp string `protobuf:"bytes,2,opt,name=timestamp,proto3" json:"timestamp,omitempty"`
	// node_name is the name of the node that the pod is running on
	NodeName string `protobuf:"bytes,3,opt,name=node_name,json=nodeName,proto3" json:"node_name,omitempty"`
	// restart_id is a UUID assigned to each pod during start
	// used to detect if the pod / node has restarted
	// only used in the request
	RestartId string `protobuf:"bytes,4,opt,name=restart_id,json=restartId,proto3" json:"restart_id,omitempty"`
	// count is an incremental id assigned to each request
	// jumps in the count are used to detect packet loss
...
func (*Heartbeat) Descriptor() ([]byte, []int) { return fileDescriptorAgent, []int{9} }

func (m *Heartbeat) GetType() Heartbeat_Type {
	if m != nil {
		return m.Type
	}
...
func (m *Heartbeat) GetNodeName() string {
	if m != nil {
		return m.NodeName
	}
	return ""
...
func (m *Heartbeat) GetRestartId() string {
	if m != nil {
		return m.RestartId
	}
	return ""
...
func (m *Heartbeat) GetCount() int64 {
	if m != nil {
		return m.Count
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*Heartbeat)(nil), "agentpb.Heartbeat")
	...
	proto.RegisterEnum("agentpb.Heartbeat_Type", Heartbeat_Type_name, Heartbeat_Type_value)
}
...
func (m *Heartbeat) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.RestartId) > 0 {
		dAtA[i] = 0x22
		i++
		i = encodeVarintAgent(dAtA, i, uint64(len(m.RestartId)))
		i += copy(dAtA[i:], m.RestartId)
	}
	if m.Count != 0 {
		dAtA[i] = 0x28
		i++
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= (Heartbeat_Type(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RestartId", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RestartId = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 5:
			if wireType != 0 {
...
var fileDescriptorAgent = []byte{
	...
	,
}
