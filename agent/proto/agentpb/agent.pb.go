...
type TimelineEvent struct {
	...
	//	*TimelineEvent_NodeOnline
	//	*TimelineEvent_NodeOffline
...
type TimelineEvent_ClusterHealthy struct {
	ClusterHealthy *ClusterHealthy `protobuf:"bytes,3,opt,name=clusterHealthy,proto3,oneof"`
}
type TimelineEvent_ClusterDegraded struct {
	ClusterDegraded *ClusterDegraded `protobuf:"bytes,4,opt,name=clusterDegraded,proto3,oneof"`
}
type TimelineEvent_ClusterUpgrade struct {
	ClusterUpgrade *ClusterUpgrade `protobuf:"bytes,5,opt,name=clusterUpgrade,proto3,oneof"`
}
type TimelineEvent_NodeAdded struct {
	NodeAdded *NodeAdded `protobuf:"bytes,6,opt,name=nodeAdded,proto3,oneof"`
}
type TimelineEvent_NodeRemoved struct {
	NodeRemoved *NodeRemoved `protobuf:"bytes,7,opt,name=nodeRemoved,proto3,oneof"`
}
type TimelineEvent_NodeHealthy struct {
	NodeHealthy *NodeHealthy `protobuf:"bytes,8,opt,name=nodeHealthy,proto3,oneof"`
}
type TimelineEvent_NodeDegraded struct {
	NodeDegraded *NodeDegraded `protobuf:"bytes,9,opt,name=nodeDegraded,proto3,oneof"`
}
type TimelineEvent_ProbeSucceeded struct {
	ProbeSucceeded *ProbeSucceeded `protobuf:"bytes,10,opt,name=probeSucceeded,proto3,oneof"`
}
type TimelineEvent_ProbeFailed struct {
	ProbeFailed *ProbeFailed `protobuf:"bytes,11,opt,name=probeFailed,proto3,oneof"`
}
type TimelineEvent_LeaderElected struct {
	LeaderElected *LeaderElected `protobuf:"bytes,12,opt,name=leaderElected,proto3,oneof"`
}
type TimelineEvent_NodeOnline struct {
	NodeOnline *NodeOnline `protobuf:"bytes,13,opt,name=nodeOnline,proto3,oneof"`
}
type TimelineEvent_NodeOffline struct {
	NodeOffline *NodeOffline `protobuf:"bytes,14,opt,name=nodeOffline,proto3,oneof"`
}
...
func (*TimelineEvent_NodeOnline) isTimelineEvent_Data()      {}
func (*TimelineEvent_NodeOffline) isTimelineEvent_Data()     {}
...
func (m *TimelineEvent) GetNodeOnline() *NodeOnline {
	if x, ok := m.GetData().(*TimelineEvent_NodeOnline); ok {
		return x.NodeOnline
	}
	return nil
}

func (m *TimelineEvent) GetNodeOffline() *NodeOffline {
	if x, ok := m.GetData().(*TimelineEvent_NodeOffline); ok {
...
func (*TimelineEvent) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _TimelineEvent_OneofMarshaler, _TimelineEvent_OneofUnmarshaler, _TimelineEvent_OneofSizer, []interface{}{
		...
		(*TimelineEvent_NodeOnline)(nil),
		(*TimelineEvent_NodeOffline)(nil),
	}
}
...
func _TimelineEvent_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *TimelineEvent_NodeOnline:
		_ = b.EncodeVarint(13<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.NodeOnline); err != nil {
			return err
		}
	case *TimelineEvent_NodeOffline:
		_ = b.EncodeVarint(14<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.NodeOffline); err != nil {
			return err
		}
	case nil:
	default:
...
func _TimelineEvent_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 12: // data.leaderElected
		...
		return true, err
	case 13: // data.nodeOnline
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(NodeOnline)
		err := b.DecodeMessage(msg)
		m.Data = &TimelineEvent_NodeOnline{msg}
		return true, err
	case 14: // data.nodeOffline
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(NodeOffline)
		err := b.DecodeMessage(msg)
		m.Data = &TimelineEvent_NodeOffline{msg}
		return true, err
	default:
		return false, nil
	}
...
func _TimelineEvent_OneofSizer(msg proto.Message) (n int) {
	...
	case *TimelineEvent_LeaderElected:
		...
		n += s
	case *TimelineEvent_NodeOnline:
		s := proto.Size(x.NodeOnline)
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *TimelineEvent_NodeOffline:
		s := proto.Size(x.NodeOffline)
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case nil:
...
var fileDescriptor_56ede974c0020f77 = []byte{
	...
	,
}
...
func (m *TimelineEvent_UnknownEvent) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.UnknownEvent != nil {
		...
		n10, err := m.UnknownEvent.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n10
...
func (m *TimelineEvent_ClusterHealthy) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ClusterHealthy != nil {
		...
		n11, err := m.ClusterHealthy.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n11
...
func (m *TimelineEvent_ClusterDegraded) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ClusterDegraded != nil {
		...
		n12, err := m.ClusterDegraded.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n12
...
func (m *TimelineEvent_ClusterUpgrade) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ClusterUpgrade != nil {
		...
		n13, err := m.ClusterUpgrade.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n13
...
func (m *TimelineEvent_NodeAdded) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.NodeAdded != nil {
		...
		n14, err := m.NodeAdded.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n14
...
func (m *TimelineEvent_NodeRemoved) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.NodeRemoved != nil {
		...
		n15, err := m.NodeRemoved.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n15
...
func (m *TimelineEvent_NodeHealthy) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.NodeHealthy != nil {
		...
		n16, err := m.NodeHealthy.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n16
...
func (m *TimelineEvent_NodeDegraded) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.NodeDegraded != nil {
		...
		n17, err := m.NodeDegraded.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n17
...
func (m *TimelineEvent_ProbeSucceeded) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ProbeSucceeded != nil {
		...
		n18, err := m.ProbeSucceeded.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n18
...
func (m *TimelineEvent_ProbeFailed) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ProbeFailed != nil {
		...
		n19, err := m.ProbeFailed.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n19
...
func (m *TimelineEvent_LeaderElected) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.LeaderElected != nil {
		...
		n20, err := m.LeaderElected.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n20
...
func (m *TimelineEvent_NodeOnline) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.NodeOnline != nil {
		dAtA[i] = 0x6a
		i++
		i = encodeVarintAgent(dAtA, i, uint64(m.NodeOnline.Size()))
		n21, err := m.NodeOnline.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n21
...
func (m *TimelineEvent_NodeOffline) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.NodeOffline != nil {
		dAtA[i] = 0x72
		i++
		i = encodeVarintAgent(dAtA, i, uint64(m.NodeOffline.Size()))
		n22, err := m.NodeOffline.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n22
...
func (m *TimelineEvent_NodeOnline) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TimelineEvent_NodeOffline) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TimelineEvent) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NodeOnline", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Data = &TimelineEvent_NodeOnline{v}
			iNdEx = postIndex
		case 14:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NodeOffline", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Data = &TimelineEvent_NodeOffline{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipAgent(dAtA[iNdEx:])
